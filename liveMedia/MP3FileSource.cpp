...
MP3FileSource::MP3FileSource(UsageEnvironment &env, FILE *fid)
	: FramedFileSource(env, fid), fStreamState(new MP3StreamState)
	, fHaveStartedReading(False), fHaveBeenInitialized(False), fLimitNumBytesToStream(False), fNumBytesToStream(0)
{
