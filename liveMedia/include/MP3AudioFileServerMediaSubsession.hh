...
{
public:
	static MP3AudioFileServerMediaSubsession *createNew(UsageEnvironment &env,
...
protected:
	...
	void getBaseStreams(FramedSource *frontStream, FramedSource *&sourceMP3Stream, ADUFromMP3Source *&aduStream/*if any*/);
