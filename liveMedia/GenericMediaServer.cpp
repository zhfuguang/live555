...
GenericMediaServer::GenericMediaServer(UsageEnvironment &env, int ourSocketIPv4, int ourSocketIPv6, Port ourPort, unsigned reclamationSeconds)
	...
	, fPreviousClientSessionId(0), fTLSCertificateFileName(NULL), fTLSPrivateKeyFileName(NULL)
{
...
GenericMediaServer::ClientConnection::ClientConnection(GenericMediaServer &ourServer, int clientSocket, struct sockaddr_storage const &clientAddr, Boolean useTLS)
